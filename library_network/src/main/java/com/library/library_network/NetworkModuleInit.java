package com.library.library_network;
...
/**
 * Creat by GuoYh
 * com.library.library_network
 * 2020/3/30
 */
public class NetworkModuleInit implements IModuleInit {
    @Override
    public boolean onInitAhead(Application application) {
        initNetworkInit(application);
        return false;
    }

    private void initNetworkInit(Application application) {
...
//        params.put("appId", AppConstant.APPID);
        ...
        EasyHttp.getInstance()
                ...
                //可以全局统一设置全局URL
                .setBaseUrl(NetworkConst.BASEURL)//设置全局URL  url只能是域名 或者域名+端口号
