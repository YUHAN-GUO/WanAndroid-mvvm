...
public class MmkvHelper {
    ...
    private static String FRIST = "MMKV_frist";
    ...
    public <T> T getResult(String key, Class<T> t) {
    ...
    public void putResult(String key, Object object) {
        String jsonString = new GsonBuilder().create().toJson(object);
        mmkv.encode(key, jsonString);
    }

    public void putFrist(boolean is) {
        put(FRIST, is);
    }

    public Boolean getFrist() {
        return mmkv.decodeBool(FRIST,true);
    }
